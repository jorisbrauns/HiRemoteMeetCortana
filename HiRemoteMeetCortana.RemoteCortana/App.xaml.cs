...
namespace HiRemoteMeetCortana.RemoteCortana
{
    /// <summary>
    /// Bootstrap class where all the fun begins!
    /// </summary>
    sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                {
                    // Launching normally.
                    rootFrame.Navigate(typeof(View.MainView), "");
                }
                else
                {
                    // Launching with arguments. We assume, for now, that this is likely so just go to main view as well
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            ViewModel.VoiceCommand? navigationCommand = null;
            ...
            if (args.Kind == ActivationKind.VoiceCommand)
            {
                ...
                // Get the name of the voice command and the text spoken. See VoiceCommands.xml for
                ...
                switch (voiceCommandName)
                {
                    case "showTripToDestination":
                        ...
                        navigationCommand = new ViewModel.VoiceCommand(
                            voiceCommandName,
                            commandMode,
                            textSpoken,
                            destination);
                        ...
                        navigationToPageType = typeof(View.MainView);
                        break;
                    default:
